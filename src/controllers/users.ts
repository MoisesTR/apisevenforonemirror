        ...
        if (req.file) {
            ...
            if (req.user.image) {
                try {
                    ...
                    console.log(
                        new AppError(
                            'Ha ocurrido un error al eliminar la imagen anterior!',
                            400,
                            'ERRIMGDEL',
                        ),
                    );
...
export const changeStateUser = catchAsync(
    async (req: Express.Request, res: Express.Response, next: NextFunction) => {
...
export const getEmailByUserName = catchAsync(
    async (req: Express.Request, res: Express.Response, next: NextFunction) => {
        ...
        if (!user) {
            ...
            return next(
                new AppError('Usuario deshabilitado, contacte con el soporte de 7x1!.', 403, 'EPUSER'),
            );
        }
        try {
...
export const updatePaypalEmail = catchAsync(
    async (req: Express.Request, res: Express.Response, next: NextFunction) => {
